...
`fraktur_latin`, `blackboard_latin`, `bold_latin`, `typewriter_latin`,
`bold_digits`, `typewriter_digits`, and `bold_greek`. Their
...
| `upright_latin_to_typewriter_latin` | `upright_latin` | `typewriter_latin` | `.typewriter` |
| `ascii_digits_to_bold_digits` | `ascii_digits` | `bold_digits` | `.bold` |
| `ascii_digits_to_typewriter_digits` | `ascii_digits` | `typewriter_digits` | `.typewriter` |
